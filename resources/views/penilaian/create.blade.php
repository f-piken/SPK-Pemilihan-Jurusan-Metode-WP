    ...
    <section class="section">
      <div class="row" >
        <div class="col-lg-6" style="width: 1500px;">
          <a href="{{ route('kriteria.index') }}" class="btn btn-primary mb-3">Data Penilaian</a>
          <div class="card">
            <div class="card-body">
                  ...
                  <label for="id_kriteria" class="form-label">Kriteria</label>
                    <select name="id_kriteria" id="id_kriteria" class="form-select">
                        @foreach($kriteria as $ktr)
                            <option value="{{ $ktr->id_kriteria }}">{{ $ktr->nama_kriteria }}</option>
                        @endforeach
                    </select>
                <div class="mb-3">
                    <label for="nilai" class="form-label">Nilai</label>
                    <input class="form-control" type="number" name="nilai" id="nilai" min="0" max="100">
                </div>
