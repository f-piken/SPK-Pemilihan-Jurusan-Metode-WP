    ...
    <section class="section">
      <div class="row" >
        <div class="col-lg-6" style="width: 1500px;">
          <a href="{{ route('penilaian.create') }}" class="btn btn-primary mb-3">Add</a>
          <a href="{{ url('/pendownloadPdf') }}" class="btn btn-primary mb-3">Cetak</a>
          <div class="card">
            <div class="card-body">
                ...
                <tbody>
                  @foreach ($penilaian as $no => $hasil)
                    <tr>
                      ...
                      <td>{{ $hasil-> nilai}}</td>
                      <td>
                        <form action="{{ route('penilaian.destroy',$hasil->id_penilaian) }}" method="POST">
                          @csrf
                          @method('delete')
