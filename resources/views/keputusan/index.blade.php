    ...
    <section class="section">
      <div class="row" >
        <div class="col-lg-6" style="width: 1500px;">
          <a href="{{ url('/kepdownloadPdf') }}" class="btn btn-primary mb-3">Cetak</a>
          <div class="card">
            <div class="card-body">
                ...
                <tbody>
                  @foreach ($keputusan as $no => $hasil)
                    <tr>
                      ...
                      <td>
                        <form action="{{ route('keputusan.destroy',$hasil->id_keputusan) }}" method="POST">
                          @csrf
                          @method('delete')
                          {{-- <a href="{{ route('keputusan.edit',$hasil->id_keputusan) }}" class="btn btn-success btn-sm">Edit</a> --}}
