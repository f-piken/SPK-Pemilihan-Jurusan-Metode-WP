    ...
    <section class="section">
      <div class="row" >
        <div class="col-lg-6" style="width: 1500px;">
          <a href="{{ route('kriteria.index') }}" class="btn btn-primary mb-3">Data Kriteria</a>
          <div class="card">
            <div class="card-body">
                <form action="{{ route('kriteria.update', $kriteria->id_kriteria) }}" method="POST">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" name="nama" value="{{ old('nama', $kriteria->nama_kriteria) }}" id="nama" >
                    </div>
                    <div class="mb-3">
                      <label for="bobot" class="form-label">Bobot</label>
                      <input type="number" step="0.1" class="form-control" name="bobot" value="{{ old('jenis', $kriteria->bobot) }}" id="bobot" >
                    </div>
                    <div class="mb-3">
